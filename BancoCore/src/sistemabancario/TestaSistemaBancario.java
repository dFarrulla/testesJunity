...
public class TestaSistemaBancario{
	...
	private static void inicializaSistemaBancario() {
		...
		//criando e inserindo duas listas de contas correntes do banco
		...
		//criando dois clientes e assciando as contas criadas acima a eles]
		
		Cliente cliente01 = new Cliente(1, "João da Silva", 20, "joaodasilva@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Maria da Silva", 18, "mariadasilva@gmail.com", conta02.getId(), true);
		//inserindo os clientes criados na lista de clientesdo banco
